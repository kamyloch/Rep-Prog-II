...
public class BungalowPremium extends Bungalow{
    ...
    //Constructor
    public BungalowPremium(String nom_, String Id_, String mida_, int numHabit_, int capacitat_,int places_,boolean terrassa_,boolean televisio_,boolean aireFred_,String codiWifi_,boolean llencolsTovalloles_){
