...
public class Bungalow extends Casa implements Serializable {
    ...
    //Constructor
    public Bungalow (String nom_, String Id_,boolean estat,String iluminacio, float mida_, int numHabit_, int capacitat_,int places_,boolean terrassa_,boolean televisio_,boolean aireFred_){
